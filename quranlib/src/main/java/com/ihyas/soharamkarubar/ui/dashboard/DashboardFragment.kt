...
//    private val adBannerView: AdBannerView? = null
...
//        loadInterstitialAd()
    ...
    override fun onResume() {
        super.onResume()
//        showInterstitial()
        binding.adViewContainer.refreshAd()
    }
...
////        val mAdView = binding.adViewContainer
...
//        adView.adUnitId = ADIdProvider.getBannerAdId(BannerAdType.BANNER_AD_TYPE_MAIN_BOTTOM)
